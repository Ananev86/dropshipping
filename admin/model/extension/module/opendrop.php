<?php
class ModelExtensionModuleOpendrop extends Model {
   ...
   public function addSupplier($data)
   {
       ...
       $this->db->query('insert into suppliers set name="'.$data['name'].'",status="'.$data['status'].'",feed="'.$data['feed'].'",date_added=NOW()');
       $supplier_id = $this->db->getLastId();
       return $supplier_id;
   }
   public function editSupplier($id,$data)
   {
       $this->db->query('update suppliers set name="'.$data['name'].'",feed="'.$data['feed'].'",status="'.$data['status'].'" where id='.$id);
   }
